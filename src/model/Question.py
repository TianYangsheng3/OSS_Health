...
if __name__=='__main__':
    ...
    # data_proc, projects_valid, scalers, weights, pca, start, end, have_std
    # Question_1(data_proc, projects_valid, scalers, weights, pca,  start, end, have_std = have_std)
