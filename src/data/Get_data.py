...
def ProjEverydayData(start, nums, FileRootPath):
    ...
    for row in range(len(projects_data)):
        ...
        # write to file
        # data_filepath = FileRootPath + "project_" + str(project_id) + ".csv"   ### linux path
        data_filepath = FileRootPath + "project_" + str(project_id) + ".csv"      ### wins path
